 ...
 * @param {string} creatorType - Optional creator type for personalized categorization
 * @returns {Promise<Object>} Analysis result with category, platform, text, confidence
 */
export const analyzeImage = async (imageBase64, creatorType = 'content_creator') => {
  ...
  try {
    ...
    const response = await fetch(requestUrl, {
      ...
      body: JSON.stringify({ imageBase64, creatorType }),
    });
